...
func FindKeyValue(k string, v string) (kk string, vv string) {
	...
	// ////////////////////////////////
	var url string = "http://127.0.0.1:3001/api/v1/find/keyvalue"
...
func CreateKeyValue(k string, v string) (kk string, vv string) {
	...
	// ////////////////////////////////
	var url string = "http://127.0.0.1:3001/api/v1/create/keyvalue"
	var d1 InputData
	d1.Key = k
	d1.Value = v
	jsonStr, _ := json.Marshal(d1)
...
func DeleteKeyValue(k string, v string) (kk string, vv string) {
	...
	// ////////////////////////////////
	var url string = "http://127.0.0.1:3001/api/v1/delete/keyvalue"
	var d1 InputData
	d1.Key = k
	d1.Value = v
	jsonStr, _ := json.Marshal(d1)
...
func printTable(header []string, x map[string]string) {
	...
	t.SetColumnConfigs([]table.ColumnConfig{
		{Number: 1, Align: text.AlignCenter, AlignFooter: text.AlignCenter, AlignHeader: text.AlignCenter, Colors: text.Colors{text.FgHiYellow, text.Bold}, ColorsHeader: text.Colors{text.FgBlack, text.BgHiYellow}},
		{Number: 2, Align: text.AlignCenter, AlignFooter: text.AlignCenter, AlignHeader: text.AlignCenter, Colors: text.Colors{text.FgHiYellow, text.Bold}, ColorsHeader: text.Colors{text.FgBlack, text.BgHiYellow}}})
