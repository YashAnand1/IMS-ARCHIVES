...
func FindKeyValue(k string, v string) (kk string, vv string) {
	...
	// ////////////////////////////////
	var url string = "http://192.168.146.149:3000/api/v1/find/keyvalue"
...
func CreateKeyValue(k string, v string) (kk string, vv string) {
	...
	// ////////////////////////////////
	var url string = "http://192.168.146.149:3000/api/v1/create/keyvalue"
	var d1 InputData
	d1.Key = k
	d1.Value = v
	jsonStr, _ := json.Marshal(d1)
...
func DeleteKeyValue(k string, v string) (kk string, vv string) {
	...
	// ////////////////////////////////
	var url string = "http://192.168.146.149:3000/api/v1/delete/keyvalue"
	var d1 InputData
	d1.Key = k
	d1.Value = v
	jsonStr, _ := json.Marshal(d1)
