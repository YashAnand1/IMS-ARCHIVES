...
`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if numberof_key == 4 { //turning it into 3 because /servers/Physical/IP/Hostname is to be run without first slash to get key
		...
		if numberof_key == 6 {
			var url string = "localhost:8181/" + "servers/delete"
			////////////////////////
