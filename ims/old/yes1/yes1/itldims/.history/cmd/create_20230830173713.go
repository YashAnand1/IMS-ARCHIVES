...
var create = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if numberof_key == 5 {
			...
			etcdKey := key
			etcdValue := components[4] // The last component of the key
			...
			if resp.StatusCode == 200 {
				...
				fmt.Printf("Key: %s is netered as %s succesfully", "servers/Physical/10.246.40.139/Hostname", etcdKey, etcdValue)
