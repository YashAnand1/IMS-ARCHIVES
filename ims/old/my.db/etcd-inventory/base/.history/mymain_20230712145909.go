...
var ( //#3
	// File pathsi
	excelFile = "/home/additi/my.db/etcd-inventory/etcd.xlsx"
	csvFile   = "/home/additi/my.db/etcd-inventory/myetcd.csv"
	etcdHost  = "localhost:2379"
)

type ServerData map[string]string //#4

func convertExcelToCSV(excelFile, csvFile string) { //#5
	// Open the Excel file
